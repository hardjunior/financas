...
$qr=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=1 AND conta=1 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje'");
$row=mysqli_fetch_array($qr);
$entradas=$row['total'];
$qr=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=1 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje'");
$row=mysqli_fetch_array($qr);
$saidas=$row['total'];
//SAIDAS E ENTRADAS ANO
$qr2=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=1 AND conta=1 AND usuario='$usuario' AND ano='$ano_hoje'");
$row2=mysqli_fetch_array($qr2);
$entradasano=$row2['total'];
$qr2=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=1 AND usuario='$usuario' AND ano='$ano_hoje'");
$row2=mysqli_fetch_array($qr2);
$saidasano=$row2['total'];
//SAIDAS E ENTRADAS MES TODAS AS CONTAS
$qr3=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=1 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje'");
$row3=mysqli_fetch_array($qr3);
$gastoscctotal=$row3['total'];
$qr3=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=2 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje'");
$row3=mysqli_fetch_array($qr3);
$gastosccv=$row3['total'];
$qr3=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=3 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje'");
$row3=mysqli_fetch_array($qr3);
$gastosccm=$row3['total'];
//calcular o valor total gasto na conta corrente
$mescalculo=$mes_hoje-1;
$qr3=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=2 AND usuario='$usuario' AND mes='$mescalculo' AND ano='$ano_hoje'");
$row3=mysqli_fetch_array($qr3);
$gastosccvmant=$row3['total'];
$qr3=mysqli_query($_SG['link'],"SELECT SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=3 AND usuario='$usuario' AND mes='$mescalculo' AND ano='$ano_hoje'");
$row3=mysqli_fetch_array($qr3);
...
$qrcem=mysqli_query($_SG['link'],"SELECT mes, SUM(valor) as total FROM movimentos WHERE tipo=1 AND conta=1 AND usuario='$usuario' AND mes='$mescalc' AND ano='$ano_hoje' GROUP BY mes");
...
$qrcsm=mysqli_query($_SG['link'],"SELECT mes, SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=1 AND usuario='$usuario' AND mes='$mescalc1' AND ano='$ano_hoje' GROUP BY mes");
...
$qrcart=mysqli_query($_SG['link'],"SELECT mes, SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=2 AND usuario='$usuario' AND mes='$mescalculocartao' AND ano='$ano_hoje' GROUP BY mes");
...
$qrcart2=mysqli_query($_SG['link'],"SELECT mes, SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=3 AND usuario='$usuario' AND mes='$mescalculocartao1' AND ano='$ano_hoje' GROUP BY mes");
...
$i3=0;
$qrcatmesesaida=mysqli_query($_SG['link'],"SELECT cat, SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=1 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje' GROUP BY cat");
while ($rowcatemesesaida=mysqli_fetch_array($qrcatmesesaida)){
$cat2=$rowcatemesesaida['cat'];
$qr3=mysqli_query($_SG['link'],"SELECT nome FROM categorias WHERE id='$cat2'");
$row3=mysqli_fetch_array($qr3);
...
$totalcatmese=array();
$i2=0;
$qrcatmese=mysqli_query($_SG['link'],"SELECT cat, SUM(valor) as total FROM movimentos WHERE tipo=1 AND conta=1 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje' GROUP BY cat");
...
$i5=0;
$qrcatcartaov=mysqli_query($_SG['link'],"SELECT cat, SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=2 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje' GROUP BY cat");
while ($rowcatcartaov=mysqli_fetch_array($qrcatcartaov)){
$catcv1=$rowcatcartaov['cat'];
$qrcatcv1=mysqli_query($_SG['link'],"SELECT nome FROM categorias WHERE id='$catcv1'");
...
$i6=0;
$qrcatcartaom=mysqli_query($_SG['link'],"SELECT cat, SUM(valor) as total FROM movimentos WHERE tipo=0 AND conta=3 AND usuario='$usuario' AND mes='$mes_hoje' AND ano='$ano_hoje' GROUP BY cat");
while ($rowcatcartaom=mysqli_fetch_array($qrcatcartaom)){
$catcm2=$rowcatcartaom['cat'];
$qrcatcm2=mysqli_query($_SG['link'],"SELECT nome FROM categorias WHERE id='$catcm2'");
