...
$qr=mysqli_query($_SG['link'],"SELECT id, nome FROM usuarios where usuario='$usuario'");
...
mysqli_query($_SG['link'],"INSERT INTO usuarios (nome, sobrenome, usuario, senha, data) VALUES ('$nome', '$sobrenome', '$usuario', SHA1('$senha'), '$datacad')");
...
mysqli_query($_SG['link'],"UPDATE usuarios SET senha=SHA1('$novasenha') WHERE id='$usuario'");
echo mysqli_error($_SG['link']);
echo "<script>
