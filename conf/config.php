...
/**
* Agradescimentos a: hardjunior.sytes.net
* e-mail: hardjunior1@gmail.com
*/
// ==============================
...
if ($_SG['conectaServidor'] == true) {
  $_SG['link'] = mysqli_connect($_SG['servidor'], $_SG['usuario'], $_SG['senha']) or die("MySQL: Não foi possível conectar-se ao servidor.");
  mysqli_select_db($_SG['link'], $_SG['banco']) or die("MySQL: Não foi possível conectar-se ao banco de dados.");
  mysqli_query($_SG['link'],"SET NAMES 'utf8'");
  mysqli_query($_SG['link'],'SET character_set_connection=utf8');
  mysqli_query($_SG['link'],'SET character_set_client=utf8');
  mysqli_query($_SG['link'],'SET character_set_results=utf8');
}
